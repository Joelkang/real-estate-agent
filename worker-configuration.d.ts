/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 2e61675725dc00cd698a92cd94f85f64)
...
declare namespace Cloudflare {
	interface Env {
		...
		RealEstateAgent: DurableObjectNamespace<import("./src/server").RealEstateAgent>;
		AI: Ai;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GOOGLE_AI_STUDIO_TOKEN" | "NOTION_INTEGRATION_TOKEN" | "GOOGLE_AI_MODEL" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_AI_GATEWAY_API_TOKEN" | "CLOUDFLARE_AI_GATEWAY_ID">> {}
}
